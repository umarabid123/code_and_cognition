...
- Relate OOP to **real-world scenarios**
...
- **You define a class** → it acts like a **recipe**  
- **You create objects** → they are the actual **dishes** made using that recipe
